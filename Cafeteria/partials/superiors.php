...
<div class="container-xxl pt-5 pb-3 ">
    <div class="container ">
        <div class="text-center wow fadeInUp " data-wow-delay="0.1s ">
            <h5 class="section-title ff-secondary text-center text-primary fw-normal ">Superiors</h5>
            <h1 class="mb-5 ">Our Masters</h1>
        </div>
        <div class="row g-5">
            <!-- Cheifs -->
            <?php
                //Connection
                include('conn.php');
                $query = "SELECT * FROM `cheifs` WHERE team like '%cs%'";
                                ...
                                <div class="card">
                                    ...
                                    <div class="main-text">
                                        ...
                                        if ($phone != null) {
                                            ...
                                            echo '<p class="text-tertiary text-uppercase"><i class="fa fa-ban text-danger mx-2"></i>No Number Added</p>';
                                        }
                                        //Number End
                                        echo '
